...
if (!empty($_SESSION['cart'])) {
    ...
    foreach($_SESSION['cart'] as $key => $item) { ?>
        <tr>
            ...
            <td id="product_price_<?php echo $key; ?>">
            ...
            <td>  
                ...
                onchange="updateCart(<?php echo $key; ?>, this.value, <?php echo $item['product_price']; ?>, <?php $_SESSION['total']?>)" 
                >
...
<tr>
    ...
    <td id="total_price">$<?php echo empty($_SESSION['cart']) ? 0 : $_SESSION['total']; ?></td>
</tr>
</tbody>
            </table>
          </div>
